...
#                 results.plot(y=[targets[i] + "_Forecast", targets[i]], x=date_time_column, style=['bs-', 'ro-'],
#                              title=title_str)
# =============================================================================
...
def create_model():    
            ...
            dense1 = LSTM(224, return_sequences= True, activation='relu' , input_shape=i_shape_lstm)(visible1)
            dense2 = LSTM(240, return_sequences= True, activation=LeakyReLU, input_shape=i_shape_lstm)(dense1)
            dense3 = LSTM(80, return_sequences= True, activation='relu', input_shape=i_shape_lstm)(dense2)
            do_lstm = Dropout(0.0, seed=123)(dense3)
            dense4 = LSTM(128)(do_lstm)
            flat1 = Flatten()(dense4)    
    
            visible2 = Input(shape=(i_shape_ffnn))        
            dense5 = Dense(144, activation=LeakyReLU)(visible2)        
            dense6 = Dense(160, activation='sigmoid')(dense5)
            dense7 = Dense(224, activation='tanh')(dense6)        
            do_ffnn = Dropout(0.155556, seed=123)(dense7)
            dense8 = Dense(80, activation='relu')(do_ffnn)
            flat2 = Flatten()(dense8)
    
            merged = concatenate([flat1, flat2])
            dense_f = Dense(240, activation='sigmoid')(merged)        
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='3/1/2021 00:00', end_time='6/1/2021  00:00',
                                ...
                                path="/home/coconnor/BM_results_MH_1-19")