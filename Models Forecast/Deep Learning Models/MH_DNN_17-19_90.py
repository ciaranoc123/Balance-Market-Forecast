...
def create_model():    
            ...
            dense1 = LSTM(128, return_sequences= True, activation='relu', input_shape=i_shape_lstm)(visible1)
            dense2 = LSTM(176, return_sequences= True, activation='relu', input_shape=i_shape_lstm)(dense1)
            dense3 = LSTM(128, return_sequences= True, activation=LeakyReLU, input_shape=i_shape_lstm)(dense2)
            do_lstm = Dropout(0.111111, seed=123)(dense3)
            dense4 = LSTM(32)(do_lstm)
            flat1 = Flatten()(dense4)    
    
            visible2 = Input(shape=(i_shape_ffnn))        
            dense5 = Dense(192, activation='sigmoid')(visible2)        
            dense6 = Dense(96, activation='tanh')(dense5)
            dense7 = Dense(16, activation='sigmoid')(dense6)        
            do_ffnn = Dropout(0.088889, seed=123)(dense7)
            dense8 = Dense(192, activation='relu')(do_ffnn)
            flat2 = Flatten()(dense8)
    
            merged = concatenate([flat1, flat2])
            dense_f = Dense(144, activation='tanh')(merged)        
...
mmo = KerasRegressor(build_fn=create_model, epochs=300, batch_size=48, verbose=2, callbacks=[es])
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='3/1/2021 00:00', end_time='6/1/2021  00:00',
                                ...
                                path="/home/coconnor/BM_results_MH_17-19_90")