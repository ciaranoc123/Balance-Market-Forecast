...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 27 13:38:53 2022
...
def create_model():
            ...
            for i in range(2):
                nn.add(Dense(64, input_shape=i_shape, activation=LeakyReLU))
                
            for i in range(1):
                nn.add(Dense(192, activation='tanh'))
   
            for i in range(2):
                nn.add(Dense(80, activation='tanh'))
            
            nn.add(Dropout(0.066667, seed=123))
            
            for i in range(2):
                nn.add(Dense(160, activation='relu'))
                
            nn.add(Dense(240, activation=LeakyReLU))
            nn.add(Dense(16))
            opt = Adam(lr =0.002311)
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='9/1/2020 00:00', end_time='12/1/2020  00:00',
                                ...
                                path="/home/coconnor/BM_results_SH_13_30")