...
def create_model():    
            ...
            dense3 = LSTM(64, return_sequences= True, activation='tanh' , input_shape=i_shape_lstm)(do_lstm)
            flat1 = Flatten()(dense3)    
    
            visible2 = Input(shape=(i_shape_ffnn))        
            dense5 = Dense(16, activation='tanh')(visible2)        
            dense6 = Dense(16, activation='tanh')(dense5)
            do_ffnn = Dropout(0.000000, seed=123)(dense6)
            dense7 = Dense(16, activation='tanh')(do_ffnn)
            flat2 = Flatten()(dense7)
    
            merged = concatenate([flat1, flat2])
            dense_f = Dense(128, activation='sigmoid')(merged)        
