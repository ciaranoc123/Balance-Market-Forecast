...
def create_model():    
            ...
            dense1 = LSTM(112, return_sequences= True, activation='tanh', input_shape=i_shape_lstm)(visible1)
            dense2 = LSTM(144, return_sequences= True, activation='tanh', input_shape=i_shape_lstm)(dense1)
            dense3 = LSTM(64, return_sequences= True, activation='sigmoid', input_shape=i_shape_lstm)(dense2)
            ...
            dense6 = Dense(208, activation='relu')(dense5)
            dense7 = Dense(16, activation='tanh')(dense6)        
            do_ffnn = Dropout(0.088889, seed=123)(dense7)
            dense8 = Dense(208, activation=LeakyReLU)(do_ffnn)
            flat2 = Flatten()(dense8)
    
            merged = concatenate([flat1, flat2])
            dense_f = Dense(240, activation='relu')(merged)        
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='9/1/2020 00:00', end_time='12/1/2020  00:00',
                                ...
                                path="/home/coconnor/BM_results_MH_13(30)")