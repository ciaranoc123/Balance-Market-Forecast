...
rolling_walk_forward_validation(model=MultiOutputRegressor(XGBRegressor(learning_rate = 0.5, max_depth = 2, n_estimators =50 )), 
                                data=dat, start_time='06/1/2020 00:00',end_time='09/1/2020  00:00',
                                targets=Y.columns.values.tolist(),training_days=-90, path="/home/coconnor/BM_results_XGB_8-10_90")