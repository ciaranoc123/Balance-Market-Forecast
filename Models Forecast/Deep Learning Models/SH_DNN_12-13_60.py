...
def create_model():
            ...
            for i in range(1):
                nn.add(Dense(128, input_shape=i_shape, activation=LeakyReLU))
                
            for i in range(1):
                nn.add(Dense(224, activation='sigmoid'))
   
            for i in range(1):
                nn.add(Dense(80, activation='sigmoid'))
            
            nn.add(Dropout(0.111111, seed=123))
            
            for i in range(1):
                nn.add(Dense(80, activation='tanh'))
                
            nn.add(Dense(64, activation=LeakyReLU))
            nn.add(Dense(16))
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='9/1/2020 00:00', end_time='12/1/2020  00:00',
                                ...
                                path="/home/coconnor/BM_results_SH_12-13(60 days)")