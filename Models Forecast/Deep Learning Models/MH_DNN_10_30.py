...
def create_model():    
            ...
            dense1 = LSTM(48, return_sequences= True, activation='sigmoid' , input_shape=i_shape_lstm)(visible1)
            dense2 = LSTM(224, return_sequences= True, activation=LeakyReLU, input_shape=i_shape_lstm)(dense1)
            dense3 = LSTM(176, return_sequences= True, activation=LeakyReLU, input_shape=i_shape_lstm)(dense2)
            do_lstm = Dropout(0.088889, seed=123)(dense3)
            dense4 = LSTM(16)(do_lstm)
            flat1 = Flatten()(dense4)    
    
            visible2 = Input(shape=(i_shape_ffnn))        
            dense5 = Dense(32, activation='relu')(visible2)        
            dense6 = Dense(64, activation=LeakyReLU)(dense5)
            dense7 = Dense(240, activation=LeakyReLU)(dense6)        
            do_ffnn = Dropout(0.200000, seed=123)(dense7)
            dense8 = Dense(208, activation=LeakyReLU)(do_ffnn)
            flat2 = Flatten()(dense8)
    
            merged = concatenate([flat1, flat2])
            dense_f = Dense(208, activation='relu')(merged)        
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='6/1/2020 00:00', end_time='9/1/2020  00:00',
                                ...
                                path="/home/coconnor/BM_results_MH_10_30")