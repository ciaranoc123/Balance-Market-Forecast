...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 25 19:32:27 2022
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 18 06:27:35 2022
@author: 98718584, Joseph Collins, joseph_anthony_collins@yahoo.co.uk, 98718584@umail.ucc.ie

Purpose of file: In this file we examine a demand participant and a supply participant. Both participants are reasonably 
                 straightforward in that while they have varying volumes, the prices in their orders are typically unchanging.
                 We implement a walk forward validation process i.e. train the model, forecast on test data, roll the windows forward one day, repeat.
                 The models have not been optimised. The purpose is to simply show a basic forecast for both participants,
                 and to allow the reader to independently gauge how good/bad they think the model fit is and to understand the high level
                 approach.                    

Input: SU_400081.csv and GU_401930.csv 

To use: Save the github repository, and accompanying csv's, to a local directory.
        Circa line 441 change the "path" variable to reflect the local directory.
        To run any of the demand participant scenarios, set any of the "run_scenarioX" variables on lines circa 482-486 to True.
        To run any of the wind participant scenarios, set any of the "run_scenarioX" variables on lines circa 620-622 to True.
        Finally, if you want to run the process for different dates, simply change the "start_time" and "end_time" values on lines circa 454-455.
"""
...
#             return train_X, train_y, test_X, test_y, test_df
        ...
        rnn_train1_a=train_df[["lag_-3x1", "lag_-4x1","lag_-5x1","lag_-6x1","lag_-7x1", "lag_-8x1","lag_-9x1","lag_-10x1","lag_-11x1", "lag_-12x1","lag_-13x1","lag_-14x1","lag_-15x1", "lag_-16x1","lag_-17x1","lag_-18x1"]]
        rnn_train1_b=train_df[["lag_-19x1", "lag_-20x1","lag_-21x1","lag_-22x1","lag_-23x1", "lag_-24x1","lag_-25x1","lag_-26x1","lag_-27x1", "lag_-28x1","lag_-29x1","lag_-30x1","lag_-31x1", "lag_-32x1","lag_-33x1","lag_-34x1"]]
        rnn_train1_c=train_df[["lag_-35x1", "lag_-36x1","lag_-37x1","lag_-38x1","lag_-39x1", "lag_-40x1","lag_-41x1","lag_-42x1","lag_-43x1", "lag_-44x1","lag_-45x1","lag_-46x1","lag_-47x1", "lag_-48x1","lag_-49x1","lag_-50x1"]]

        rnn_train2_a=train_df[["lag_-3x2", "lag_-4x2","lag_-5x2","lag_-6x2","lag_-7x2", "lag_-8x2","lag_-9x2","lag_-10x2","lag_-11x2", "lag_-12x2","lag_-13x2","lag_-14x2","lag_-15x2", "lag_-16x2","lag_-17x2","lag_-18x2"]]
        rnn_train2_b=train_df[["lag_-19x2", "lag_-20x2","lag_-21x2","lag_-22x2","lag_-23x2", "lag_-24x2","lag_-25x2","lag_-26x2","lag_-27x2", "lag_-28x2","lag_-29x2","lag_-30x2","lag_-31x2", "lag_-32x2","lag_-33x2","lag_-34x2"]]
        rnn_train2_c=train_df[["lag_-35x2", "lag_-36x2","lag_-37x2","lag_-38x2","lag_-39x2", "lag_-40x2","lag_-41x2","lag_-42x2","lag_-43x2", "lag_-44x2","lag_-45x2","lag_-46x2","lag_-47x2", "lag_-48x2","lag_-49x2","lag_-50x2"]]

        rnn_train3_a=train_df[["lag_-2x3","lag_-3x3", "lag_-4x3","lag_-5x3","lag_-6x3","lag_-7x3", "lag_-8x3","lag_-9x3","lag_-10x3","lag_-11x3", "lag_-12x3","lag_-13x3","lag_-14x3","lag_-15x3", "lag_-16x3","lag_-17x3"]]
        rnn_train3_b=train_df[["lag_-18x3","lag_-19x3", "lag_-20x3","lag_-21x3","lag_-22x3","lag_-23x3", "lag_-24x3","lag_-25x3","lag_-26x3","lag_-27x3", "lag_-28x3","lag_-29x3","lag_-30x3","lag_-31x3", "lag_-32x3","lag_-33x3"]]
        rnn_train3_c=train_df[["lag_-34x3","lag_-35x3", "lag_-36x3","lag_-37x3","lag_-38x3","lag_-39x3", "lag_-40x3","lag_-41x3","lag_-42x3","lag_-43x3", "lag_-44x3","lag_-45x3","lag_-46x3","lag_-47x3", "lag_-48x3","lag_-49x3"]]

        rnn_train4_a=train_df[["lag_0x6","lag_-1x6","lag_-2x6","lag_-3x6", "lag_-4x6","lag_-5x6","lag_-6x6","lag_-7x6", "lag_-8x6","lag_-9x6","lag_-10x6","lag_-11x6", "lag_-12x6","lag_-13x6","lag_-14x6","lag_-15x6"]]
        rnn_train4_b=train_df[["lag_-16x6","lag_-17x6","lag_-18x6","lag_-19x6", "lag_-20x6","lag_-21x6","lag_-22x6","lag_-23x6", "lag_-24x6","lag_-25x6","lag_-26x6","lag_-27x6", "lag_-28x6","lag_-29x6","lag_-30x6","lag_-31x6"]]
        rnn_train4_c=train_df[["lag_-32x6","lag_-33x6","lag_-34x6","lag_-35x6", "lag_-36x6","lag_-37x6","lag_-38x6","lag_-39x6", "lag_-40x6","lag_-41x6","lag_-42x6","lag_-43x6", "lag_-44x6","lag_-45x6","lag_-46x6","lag_-47x6"]]

        rnn_train5_a=train_df[["lag_-2x12","lag_-3x12", "lag_-4x12","lag_-5x12","lag_-6x12","lag_-7x12", "lag_-8x12","lag_-9x12","lag_-10x12","lag_-11x12", "lag_-12x12","lag_-13x12","lag_-14x12","lag_-15x12", "lag_-16x12","lag_-17x12"]]
        rnn_train5_b=train_df[["lag_-18x12","lag_-19x12", "lag_-20x12","lag_-21x12","lag_-22x12","lag_-23x12", "lag_-24x12","lag_-25x12","lag_-26x12","lag_-27x12", "lag_-28x12","lag_-29x12","lag_-30x12","lag_-31x12", "lag_-32x12","lag_-33x12"]]
        rnn_train5_c=train_df[["lag_-34x12","lag_-35x12", "lag_-36x12","lag_-37x12","lag_-38x12","lag_-39x12", "lag_-40x12","lag_-41x12","lag_-42x12","lag_-43x12", "lag_-44x12","lag_-45x12","lag_-46x12","lag_-47x12", "lag_-48x12","lag_-49x12"]]

        rnn_train6=train_df[["lag_2x7","lag_3x7","lag_4x7","lag_5x7","lag_6x7","lag_7x7","lag_8x7","lag_9x7","lag_10x7","lag_11x7","lag_12x7","lag_13x7","lag_14x7","lag_15x7","lag_16x7","lag_17x7"]]
        rnn_train7=train_df[["lag_2x8","lag_3x8","lag_4x8","lag_5x8","lag_6x8","lag_7x8","lag_8x8","lag_9x8","lag_10x8","lag_11x8","lag_12x8","lag_13x8","lag_14x8","lag_15x8","lag_16x8","lag_17x8"]]
        rnn_train8=train_df[["lag_2x9","lag_3x9","lag_4x9","lag_5x9","lag_6x9","lag_7x9","lag_8x9","lag_9x9","lag_10x9","lag_11x9","lag_12x9","lag_13x9","lag_14x9","lag_15x9","lag_16x9","lag_17x9"]]
        rnn_train9=train_df[["lag_2x10","lag_3x10","lag_4x10","lag_5x10","lag_6x10","lag_7x10","lag_8x10","lag_9x10","lag_10x10","lag_11x10","lag_12x10","lag_13x10","lag_14x10","lag_15x10","lag_16x10","lag_17x10"]]
        rnn_train10=train_df[["lag_2x11","lag_3x11","lag_4x11","lag_5x11","lag_6x11","lag_7x11","lag_8x11","lag_9x11","lag_10x11","lag_11x11","lag_12x11","lag_13x11","lag_14x11","lag_15x11","lag_16x11","lag_17x11"]]



        rnn_test1_a=test_df[["lag_-3x1", "lag_-4x1","lag_-5x1","lag_-6x1","lag_-7x1", "lag_-8x1","lag_-9x1","lag_-10x1","lag_-11x1", "lag_-12x1","lag_-13x1","lag_-14x1","lag_-15x1", "lag_-16x1","lag_-17x1","lag_-18x1"]]
        rnn_test1_b=test_df[["lag_-19x1", "lag_-20x1","lag_-21x1","lag_-22x1","lag_-23x1", "lag_-24x1","lag_-25x1","lag_-26x1","lag_-27x1", "lag_-28x1","lag_-29x1","lag_-30x1","lag_-31x1", "lag_-32x1","lag_-33x1","lag_-34x1"]]
        rnn_test1_c=test_df[["lag_-35x1", "lag_-36x1","lag_-37x1","lag_-38x1","lag_-39x1", "lag_-40x1","lag_-41x1","lag_-42x1","lag_-43x1", "lag_-44x1","lag_-45x1","lag_-46x1","lag_-47x1", "lag_-48x1","lag_-49x1","lag_-50x1"]]

        rnn_test2_a=test_df[["lag_-3x2", "lag_-4x2","lag_-5x2","lag_-6x2","lag_-7x2", "lag_-8x2","lag_-9x2","lag_-10x2","lag_-11x2", "lag_-12x2","lag_-13x2","lag_-14x2","lag_-15x2", "lag_-16x2","lag_-17x2","lag_-18x2"]]
        rnn_test2_b=test_df[["lag_-19x2", "lag_-20x2","lag_-21x2","lag_-22x2","lag_-23x2", "lag_-24x2","lag_-25x2","lag_-26x2","lag_-27x2", "lag_-28x2","lag_-29x2","lag_-30x2","lag_-31x2", "lag_-32x2","lag_-33x2","lag_-34x2"]]
        rnn_test2_c=test_df[["lag_-35x2", "lag_-36x2","lag_-37x2","lag_-38x2","lag_-39x2", "lag_-40x2","lag_-41x2","lag_-42x2","lag_-43x2", "lag_-44x2","lag_-45x2","lag_-46x2","lag_-47x2", "lag_-48x2","lag_-49x2","lag_-50x2"]]

        rnn_test3_a=test_df[["lag_-2x3","lag_-3x3", "lag_-4x3","lag_-5x3","lag_-6x3","lag_-7x3", "lag_-8x3","lag_-9x3","lag_-10x3","lag_-11x3", "lag_-12x3","lag_-13x3","lag_-14x3","lag_-15x3", "lag_-16x3","lag_-17x3"]]
        rnn_test3_b=test_df[["lag_-18x3","lag_-19x3", "lag_-20x3","lag_-21x3","lag_-22x3","lag_-23x3", "lag_-24x3","lag_-25x3","lag_-26x3","lag_-27x3", "lag_-28x3","lag_-29x3","lag_-30x3","lag_-31x3", "lag_-32x3","lag_-33x3"]]
        rnn_test3_c=test_df[["lag_-34x3","lag_-35x3", "lag_-36x3","lag_-37x3","lag_-38x3","lag_-39x3", "lag_-40x3","lag_-41x3","lag_-42x3","lag_-43x3", "lag_-44x3","lag_-45x3","lag_-46x3","lag_-47x3", "lag_-48x3","lag_-49x3"]]

        rnn_test4_a=test_df[["lag_0x6","lag_-1x6","lag_-2x6","lag_-3x6", "lag_-4x6","lag_-5x6","lag_-6x6","lag_-7x6", "lag_-8x6","lag_-9x6","lag_-10x6","lag_-11x6", "lag_-12x6","lag_-13x6","lag_-14x6","lag_-15x6"]]
        rnn_test4_b=test_df[["lag_-16x6","lag_-17x6","lag_-18x6","lag_-19x6", "lag_-20x6","lag_-21x6","lag_-22x6","lag_-23x6", "lag_-24x6","lag_-25x6","lag_-26x6","lag_-27x6", "lag_-28x6","lag_-29x6","lag_-30x6","lag_-31x6"]]
        rnn_test4_c=test_df[["lag_-32x6","lag_-33x6","lag_-34x6","lag_-35x6", "lag_-36x6","lag_-37x6","lag_-38x6","lag_-39x6", "lag_-40x6","lag_-41x6","lag_-42x6","lag_-43x6", "lag_-44x6","lag_-45x6","lag_-46x6","lag_-47x6"]]

        rnn_test5_a=test_df[["lag_-2x12","lag_-3x12", "lag_-4x12","lag_-5x12","lag_-6x12","lag_-7x12", "lag_-8x12","lag_-9x12","lag_-10x12","lag_-11x12", "lag_-12x12","lag_-13x12","lag_-14x12","lag_-15x12", "lag_-16x12","lag_-17x12"]]
        rnn_test5_b=test_df[["lag_-18x12","lag_-19x12", "lag_-20x12","lag_-21x12","lag_-22x12","lag_-23x12", "lag_-24x12","lag_-25x12","lag_-26x12","lag_-27x12", "lag_-28x12","lag_-29x12","lag_-30x12","lag_-31x12", "lag_-32x12","lag_-33x12"]]
        rnn_test5_c=test_df[["lag_-34x12","lag_-35x12", "lag_-36x12","lag_-37x12","lag_-38x12","lag_-39x12", "lag_-40x12","lag_-41x12","lag_-42x12","lag_-43x12", "lag_-44x12","lag_-45x12","lag_-46x12","lag_-47x12", "lag_-48x12","lag_-49x12"]]

        rnn_test6=test_df[["lag_2x7","lag_3x7","lag_4x7","lag_5x7","lag_6x7","lag_7x7","lag_8x7","lag_9x7","lag_10x7","lag_11x7","lag_12x7","lag_13x7","lag_14x7","lag_15x7","lag_16x7","lag_17x7"]]
        rnn_test7=test_df[["lag_2x8","lag_3x8","lag_4x8","lag_5x8","lag_6x8","lag_7x8","lag_8x8","lag_9x8","lag_10x8","lag_11x8","lag_12x8","lag_13x8","lag_14x8","lag_15x8","lag_16x8","lag_17x8"]]
        rnn_test8=test_df[["lag_2x9","lag_3x9","lag_4x9","lag_5x9","lag_6x9","lag_7x9","lag_8x9","lag_9x9","lag_10x9","lag_11x9","lag_12x9","lag_13x9","lag_14x9","lag_15x9","lag_16x9","lag_17x9"]]
        rnn_test9=test_df[["lag_2x10","lag_3x10","lag_4x10","lag_5x10","lag_6x10","lag_7x10","lag_8x10","lag_9x10","lag_10x10","lag_11x10","lag_12x10","lag_13x10","lag_14x10","lag_15x10","lag_16x10","lag_17x10"]]
        rnn_test10=test_df[["lag_2x11","lag_3x11","lag_4x11","lag_5x11","lag_6x11","lag_7x11","lag_8x11","lag_9x11","lag_10x11","lag_11x11","lag_12x11","lag_13x11","lag_14x11","lag_15x11","lag_16x11","lag_17x11"]]

        rnn_Y=train_df[["lag_2y", "lag_3y", "lag_4y", "lag_5y", "lag_6y", "lag_7y", "lag_8y", "lag_9y", "lag_10y", "lag_11y", "lag_12y", "lag_13y", "lag_14y", "lag_15y", "lag_16y", "lag_17y"]]
...
def create_model():
            ...
            for i in range(1):
                nn.add(Dense(16, input_shape=i_shape, activation=LeakyReLU))
                
            for i in range(1):
                nn.add(Dense(80, activation=LeakyReLU))
   
            for i in range(1):
                nn.add(Dense(176, activation='relu'))
            
            nn.add(Dropout(0.00, seed=123))
...
mmo = KerasRegressor(build_fn=create_model, epochs=200, batch_size=48, verbose=2, callbacks=[es])

rolling_walk_forward_validation(model=mmo, data=dat, start_time='3/1/2021 00:00', end_time='6/1/2021  00:00',
                                targets=Y.columns.values.tolist(), training_days=-90,
                                path="/home/coconnor/BM_results_SH_17-19_90")
