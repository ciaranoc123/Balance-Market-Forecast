...
def create_model():
            ...
            for i in range(1):
                nn.add(Dense(144, input_shape=i_shape, activation='tanh'))
            ...
            nn.add(Dropout(0.177778, seed=123))
            
            for i in range(1):
                nn.add(Dense(224, activation='tanh'))
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='12/1/2020 00:00', end_time='3/1/2021  00:00',
                                ...
                                path="/home/coconnor/BM_results_SH_14-16_90")
