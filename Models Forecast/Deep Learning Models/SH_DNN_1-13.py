...
def create_model():
            ...
            for i in range(2):
                nn.add(Dense(208, input_shape=i_shape, activation='sigmoid'))
            for i in range(1):
                nn.add(Dense(176, activation=LeakyReLU))
   
            for i in range(2):
                nn.add(Dense(80, activation='sigmoid'))
            
            nn.add(Dropout(0.088889, seed=123))
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='9/1/2020 00:00', end_time='12/1/2020  00:00',
                                ...
                                path="/home/coconnor/BM_results_SH_1-13")
