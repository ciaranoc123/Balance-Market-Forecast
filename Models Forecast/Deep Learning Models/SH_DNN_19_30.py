...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 27 13:38:55 2022
...
def create_model():
            ...
            for i in range(2):
                nn.add(Dense(112, input_shape=i_shape, activation=LeakyReLU))
            ...
            for i in range(2):
                nn.add(Dense(160, activation=LeakyReLU))
                
            nn.add(Dense(48, activation='sigmoid'))
            nn.add(Dense(16))
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='3/1/2021 00:00', end_time='6/1/2021  00:00',
                                ...
                                path="/home/coconnor/BM_results_SH_19_30")