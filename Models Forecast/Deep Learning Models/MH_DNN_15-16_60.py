...
def create_model():    
            ...
            dense3 = LSTM(64, return_sequences= True, activation=LeakyReLU, input_shape=i_shape_lstm)(dense2)
            do_lstm = Dropout(0.00, seed=123)(dense3)
            dense4 = LSTM(224)(do_lstm)
            flat1 = Flatten()(dense4)    
    
            visible2 = Input(shape=(i_shape_ffnn))        
            dense5 = Dense(160, activation=LeakyReLU)(visible2)        
            dense6 = Dense(224, activation=LeakyReLU)(dense5)
            dense7 = Dense(80, activation='tanh')(dense6)        
            do_ffnn = Dropout(0.00, seed=123)(dense7)
            dense8 = Dense(160, activation='tanh')(do_ffnn)
            flat2 = Flatten()(dense8)
    
            merged = concatenate([flat1, flat2])
            dense_f = Dense(96, activation='tanh')(merged)        
...
rolling_walk_forward_validation(model=mmo, data=dat, start_time='12/1/2020 00:00', end_time='3/1/2021  00:00',
                                ...
                                path="/home/coconnor/BM_results_MH_15-16_60")